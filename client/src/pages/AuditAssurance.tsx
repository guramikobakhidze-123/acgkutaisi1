...
import { ArrowLeft, ShieldCheck, FileSearch, BarChart3, Scale } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-[#020654] text-white py-24 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-6" data-testid="text-audit-title">
            {t("auditAssurance")}
          </h1>
          <p className="text-xl text-slate-300 max-w-3xl leading-relaxed mb-8" data-testid="text-audit-description">
            {t("auditDescription")}
          </p>
          <Link href="/contact">
